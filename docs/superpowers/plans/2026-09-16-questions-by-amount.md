...
1. **L'investissement est à 0 € partout** tant que les virements émis ne sont pas classés. Envisagé puis **écarté le 2026-09-16** : rapprocher ces virements des versements saisis sur les comptes d'investissement de l'app (56 sur 62 correspondaient). Trop lié à une façon de tenir ses comptes ; la voie reste générale : un virement que rien ne reconnaît (ni paire, ni récurrence) pose sa question de flux, et la réponse « Investissement » le classe, lui et les libellés proches.
   **Repris et fait le 2026-09-17** (`services/banking/contributions.py`) : la voie générale reste inchangée — la question est toujours posée à qui ne saisit rien — et le rapprochement ne s'ajoute que par-dessus, au **jour exact, montant exact, candidat unique**, jamais au-dessus d'une réponse de l'utilisateur. Élargir à ±3 jours dégradait (50 uniques contre 51, 6 ambigus contre 4), donc un versement proche est seulement montré à côté de la question. Les lignes que l'app écrit elle-même (provision automatique d'un compte titres, contrepartie EUR d'un groupe crypto) portent désormais `is_auto_provision` en base et ne prouvent rien. Mesuré sur le dump : 54 opérations typées, 11 568 € d'investi qui n'apparaissait nulle part, la file passe de 110 questions et 78 409 € à 107 et 66 891 €, et aucune opération non prouvée n'a perdu sa question.
